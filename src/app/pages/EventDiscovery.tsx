...
function StatCard({ stat }: { stat: (typeof STATS)[0] }) {
  ...
  return (
    <div ref={ref} className="stagger-child text-center px-6 py-5">
      ...
      <p className="text-xs font-medium mt-1" style={{ color: "#78716c" }}>
        {stat.label}
      </p>
    </div>
  );
...
function HeroFeaturedCard({ event }: { event: Event }) {
  return (
    <Link to={`/events/${event.id}`} style={{ textDecoration: "none" }}>
      <div
        className="stagger-child card-lift relative rounded-3xl overflow-hidden group cursor-pointer"
        style={{ height: 460 }}
      >
        <img
          src={event.image}
...
function SideFeaturedCard({ event }: { event: Event }) {
  return (
    <Link to={`/events/${event.id}`} style={{ textDecoration: "none" }}>
      <div
        className="stagger-right card-lift relative rounded-2xl overflow-hidden group cursor-pointer"
        style={{ height: 218 }}
      >
        <img
          src={event.image}
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <p className="text-xs font-medium mb-1" style={{ color: "#fdba74" }}>
        ...
        <div
          ...
          onMouseEnter={(e) => {
            (e.currentTarget as HTMLElement).style.boxShadow =
              "0 12px 40px rgba(249,115,22,0.14)";
        ...
        >
          ...
          <div className="p-4">
            <h3
              ...
              style={{ color: "#1a0a00", fontFamily: "'Outfit',sans-serif" }}
            >
              {event.title}
            </h3>
            <div
            ...
            >
              ...
              <span className="flex items-center gap-1">
                <Star size={10} style={{ color: "#f97316" }} /> {event.rating}
              </span>
            </div>
            ...
            <div
              ...
              style={{ borderTop: "1px solid rgba(249,115,22,0.06)" }}
            >
              <div>
              ...
              >
                <Ticket size={11} />{" "}
                {event.tiers.reduce((s, t) => s + t.remaining, 0)} left
              </div>
            </div>
          </div>
        </div>
...
function MapPopupContent({ event }: { event: Event }) {
  return (
    <div style={{ width: 200, fontFamily: "'Outfit',sans-serif" }}>
      ...
      <p style={{ fontSize: 11, color: "#78716c", marginBottom: 4 }}>
    ...
    <div style={{ paddingTop: 68 }}>
      ...
      <div
        ...
        style={{
          minHeight: 540,
          background:
            "linear-gradient(165deg, #1a0a00 0%, #2d1400 40%, #451a04 100%)",
        }}
      >
        {/* Decorative blurred orbs */}
        <div
          className="absolute rounded-full blur-3xl orb-drift pointer-events-none"
          style={{
            width: 500,
            height: 500,
            top: -200,
        ...
        />
        <div
          className="absolute rounded-full blur-2xl orb-drift pointer-events-none"
          style={{
            width: 180,
            height: 180,
            top: 100,
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 md:px-12 py-20 md:py-28">
          {/* Badge */}
          <div
            className="anim-fade-up delay-0 inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold mb-6"
            style={{
          ...
          {/* Headline */}
          <h1
            className="anim-fade-up delay-1 text-4xl md:text-6xl lg:text-7xl font-black mb-5 max-w-3xl"
            style={{
          ...
          <p
            className="anim-fade-up delay-2 text-base md:text-lg mb-10 max-w-lg"
            style={{ color: "rgba(255,255,255,0.6)", lineHeight: 1.7 }}
          >
            Concerts, workshops, food festivals, and hidden gems — curated for
            your city, your interests, your weekend.
          </p>
          ...
          <div className="anim-fade-up delay-3 flex flex-col sm:flex-row gap-3 max-w-2xl">
            ...
            <button
              className="flex items-center gap-2 px-7 py-4 rounded-2xl text-sm font-bold transition-all duration-300 hover:opacity-90 hover:-translate-y-0.5 active:translate-y-0"
              style={{
                background: "linear-gradient(135deg,#f97316,#ef4444)",
                color: "#fff",
                whiteSpace: "nowrap",
      ...
      <div
        ref={statsRef}
        className="section-reveal max-w-[1100px] mx-auto px-6 -mt-8 relative z-10"
      >
      ...
      <div className="px-6 md:px-12 max-w-[1400px] mx-auto">
            ...
            {CATEGORIES.map(({ name, icon: CatIcon }, i) => (
              <button
                ...
                style={{
                  ...
                  border: `1.5px solid ${
                    category === name ? "transparent" : "rgba(249,115,22,0.18)"
                  }`,
                  boxShadow:
                    category === name
        ...
        <div ref={ctaRef} className="section-reveal pb-20">
          <div
            ...
            style={{
              background:
                "linear-gradient(135deg, #1a0a00 0%, #451a04 50%, #7c2d12 100%)",
            }}
          >
            {/* Orbs */}
            <div
            ...
            <div className="relative z-10">
              <h2
                className="stagger-child text-3xl md:text-4xl font-black mb-4"
                style={{ fontFamily: "'Outfit',sans-serif", color: "#fff" }}
              >
                Ready to Discover Something New?
              </h2>
              <p
                className="stagger-child text-sm md:text-base mb-8 max-w-md mx-auto"
                style={{ color: "rgba(255,255,255,0.6)" }}
              >
                Join thousands of people finding their next favorite experience
                on Planzo.
              </p>
              <div className="stagger-child flex flex-col sm:flex-row gap-3 justify-center">
                <Link to="/register">
                  <button
                    className="px-8 py-3.5 rounded-2xl text-sm font-bold transition-all duration-300 hover:-translate-y-0.5"
                    style={{
                      background: "linear-gradient(135deg,#f97316,#ef4444)",
                      color: "#fff",
                      boxShadow: "0 4px 24px rgba(249,115,22,0.4)",
